let random10 = function () {return Math.round(Math.random() * 10)}


// - створити функцію яка обчислює та повертає площу прямокутника зі сторонами а і б
let ploshaPryamokutnika = (height, weight) => height * weight;
...
let ploshaKola = (radius) => Math.PI * Math.pow(radius, 2)
